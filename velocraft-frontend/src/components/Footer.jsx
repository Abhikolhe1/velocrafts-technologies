        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-white/80 text-sm leading-relaxed">
              Empowering businesses with cutting-edge digital solutions. Web, mobile, AI, and growth services.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {quickLinks.map((link) => (
                <li key={link.to}>
                  <Link to={link.to} className="text-white/80 hover:text-accent transition-colors text-sm">
                    {link.label}
                  </Link>
                </li>
              ))}
