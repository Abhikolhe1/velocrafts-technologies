...
export default function Hero() {
  return (
    <section
      ...
      style={{ background: 'linear-gradient(135deg, #153A5B 0%, #0F576F 50%, #0a3d52 100%)' }}
    >
      <ParticleBackground />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 w-full">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            >
              Web, Mobile, AI Services & Growth Solutions that scale with your vision.
            </motion.p>
            <motion.div
          ...
          <div className="hidden lg:flex relative h-64 items-center justify-center">
            {floatingPills.map((pill, i) => (
              <motion.div
                key={pill.label}
                className="absolute px-6 py-3 rounded-2xl bg-white/10 backdrop-blur-sm border border-white/20 text-white font-medium shadow-xl"
