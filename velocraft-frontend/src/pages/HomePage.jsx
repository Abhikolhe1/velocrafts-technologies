    ...
    <section className="py-16 md:py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimateOnScroll animation="slide-in-left" delay={0.5} className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">About Velocrafts</h2>
          ...
          <AnimateStagger animation="soft-zoom" className="grid grid-cols-2 gap-4" staggerDelay={0.25}>
            {[
              ...
              <div key={m.label} className="bg-white rounded-xl p-6 border border-gray-200 flex flex-col justify-center shadow-sm" style={{ height: '120px' }}>
...
function CTA() {
  return (
    <section className="py-14 md:py-20" style={{ background: 'linear-gradient(135deg, #0a0e27 0%, #16213e 50%, #1a1f3a 100%)' }}>
