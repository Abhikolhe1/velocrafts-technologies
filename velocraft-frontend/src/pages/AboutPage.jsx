        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-primary mb-2 flex-shrink-0">
                Innovation
              </h3>
              <p
                className="text-gray-600 overflow-y-auto flex-1 min-h-0"
                title="We embrace new technologies and methodologies to deliver solutions that stay ahead of the curve."
              >
            ...
            >
              ...
              <p
                className="text-gray-600 overflow-y-auto flex-1 min-h-0"
                title="We deliver robust, maintainable code and design that meets the highest standards."
              >
                We deliver robust, maintainable code and design that meets the
                highest standards.
              </p>
            </div>
            <div
            ...
            >
              ...
              <p
                className="text-gray-600 overflow-y-auto flex-1 min-h-0"
                title="We work alongside our clients as true partners, invested in their success."
              >
                We work alongside our clients as true partners, invested in
                their success.
              </p>
            </div>
          </AnimateStagger>
